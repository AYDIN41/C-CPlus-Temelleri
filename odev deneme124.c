...
int main(){
   ...
   // scanf("")
    ...
    while(oyuncu1vurma<3){
        printf("Bir yetenek kullanýn:\n");
        if(oyuncu1==1){
    ...
    printf("Oyuncu 1 Saglik: %d Oyuuncu 2 Saglik: %d",rakipcan2,rakipcan1);


   // while(oyuncu2vurma<3){
     //   printf("bir yenetek kullanýn:\n");
        //printf("")
        //scanf("");
   // }
